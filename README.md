...
The project introduces Pseudo-Online Isolate-Detect (POID), an adaptation of the Isolate-Detect algorithm for online change-point detection.

There are three main parts in this repository:

1. Change in the mean  
The R functions implementing the POID method for detecting changes in the mean. This folder also contains the scripts used for the corresponding simulation studies.

2. Change in the slope  
The R functions implementing the POID method for detecting changes in the slope, together with the scripts used for the corresponding simulation studies.
